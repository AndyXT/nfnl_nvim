...
local function _1_()
  require("telescope").setup({extensions = {undo = {layout_config = {preview_height = 0.8}, layout_strategy = "vertical", side_by_side = true}}})
